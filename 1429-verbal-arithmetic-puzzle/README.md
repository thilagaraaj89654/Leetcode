<h2><a href="https://leetcode.com/problems/verbal-arithmetic-puzzle">Verbal Arithmetic Puzzle</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>Given an equation, represented by <code>words</code> on the left side and the <code>result</code> on the right side.</p>
